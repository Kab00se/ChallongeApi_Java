 ...
 * @author Kevin C.Y. T.
 */
public class CheckInAbortTournamentRequest {
	private final String tournamentUrlPath;
	private final Boolean includeParticipants;
    private final Boolean includeMatches;

    public CheckInAbortTournamentRequest(String urlPath, Boolean includeParticipants, Boolean includeMatches) {
    ...
    public static class Builder {
        ...
        public CheckInAbortTournamentRequest build() {
            return new CheckInAbortTournamentRequest(urlPath, includeParticipants, includeMatches);
        }
    }
}
